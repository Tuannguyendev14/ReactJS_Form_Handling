		...
		return (
			...
			<section> 
			  ...
			  <header>
				...
				<a className="toggle" href="true" >Menu</a>
				<ul className="active">
				  <li> <Link to="/" className="nav-link"> Home </Link></li> 
				  <li><a href="true">Detail</a></li>
				  <li><a href="true">Contact us</a></li>
				  <li><a href="true">About</a></li>
				  <li><a href="true">Services</a></li>
				  <li><a href="true">Prototypes</a></li>
				  <li><Link to="/form" className="nav-link"> Form</Link></li>
				  <li><Link to="/table" className="nav-link"> List  </Link></li>
				  <li className="dropdown">
					<a id="maumenu" href="true" title="Tool" className="dropdown-toggle" data-toggle="dropdown"><span className="caret" />Tool</a>
					<ul className="dropdown-menu menubar">
					  <li><Link to="/login" className="nav-link">  Log in </Link></li>
					  <li><a href="true" title="Logout">Logout</a></li>
					  <li><a href="true" title="Sign up<">Sign up</a></li>
					</ul>
				  </li>	
				</ul>
			  </header>
			  <div className="content">
				...
				<div className="buttom">
				  <a href="true" className="btn" onClick={this.watchVideo}>Watch video</a>
				  <a href="true" className="btn">Detail</a>
				</div>
			  </div>
			</section>
		  );
